# Lecture: mathematics_07_hindi

## Folder Structure

```
mathematics_07_hindi/
...
cap = cv2.VideoCapture('../videos/mathematics_07_hindi.mp4')
...
# For each transition:
ffmpeg -i ../videos/mathematics_07_hindi.mp4 \
