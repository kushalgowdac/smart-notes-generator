# Lecture: computer_networks_13_hindi

## Folder Structure

```
computer_networks_13_hindi/
...
cap = cv2.VideoCapture('../videos/computer_networks_13_hindi.mp4')
...
# For each transition:
ffmpeg -i ../videos/computer_networks_13_hindi.mp4 \
