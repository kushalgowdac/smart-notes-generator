# Lecture: mathematics_05_hindi

## Folder Structure

```
mathematics_05_hindi/
...
cap = cv2.VideoCapture('../videos/mathematics_05_hindi.mp4')
...
# For each transition:
ffmpeg -i ../videos/mathematics_05_hindi.mp4 \
